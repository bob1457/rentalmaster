...
const connectionString = "endpoint=https://applyemail.canada.communication.azure.com/;accesskey=M3hF7B2GKNkPBfF6BXIL58LKykYIk5WGkLfzbM1ntnI5HDavvg7DRiQIOWJSoGmB+EcxA1NRHXXDxpSk4B0flw==";
const senderAddress = "DoNotReply<DoNotReply@0f77ab63-3dd3-4685-89ea-cb49cf8db2bd.azurecomm.net>"
...
export async function apply(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
    ...
    const message = {
        senderAddress: "<DoNotReply@0f77ab63-3dd3-4685-89ea-cb49cf8db2bd.azurecomm.net>", //senderAddress, // "<donotreply@xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx.azurecomm.net>",
        content: {
